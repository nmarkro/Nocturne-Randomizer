...
class Script_Modifier:
    ...
    def run(self):
        ...
        self.dds3.add_new_file('/event/e500/e506/scr/e506.bf', e506) #custom_vals.SCRIPT_OBJ_PATH['e506']
        ...
        f034a_lb = self.push_bf_into_lb(f034_obj, 'f034')
...
if __name__ == '__main__':
    ...
    script_modifier = Script_Modifier(iso, dds3)
    script_modifier.run()
